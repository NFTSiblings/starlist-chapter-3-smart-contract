...
contract StarlistLootboxBetaTest is AdminPrivileges {
    address private LOSTPOETS_PAGES; // Address should be initiliased here, and be constant
    address private LOSTPOETS; // Address should be initiliased here, and be constant
    address private vault; // Address should be initiliased here
